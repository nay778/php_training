...
<body>
    ...
    <div class="table-data">
        <div class="list-title">
            <h2>medicine list</h2>
            <h2>
                <a href="create_form.php" class="g-color" title="Add list"><i class="far fa-plus-square"></i></a>
                <a href="graph.php" class="m" title="Graph"><i class="fas fa-chart-line"></i></a>
